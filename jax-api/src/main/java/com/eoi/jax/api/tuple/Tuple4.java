 ...
 * type. (That is, if you have a "class Foo extends Tuple4", then don't use instances of Foo in a
 * DataStream&lt;Tuple4&gt; / DataSet&lt;Tuple4&gt;, but declare it as DataStream&lt;Foo&gt; / DataSet&lt;Foo&gt;.)
 * </li>
 * </ul></p>
 *
...
public class Tuple4<T0, T1, T2, T3> extends Tuple {
    ...
    /**
     * Creates a string representation of the tuple in the form (f0, f1, f2, f3), where the individual fields are the
