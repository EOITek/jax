...
/**
 * 表示一个DataFrame输入和一个DataFrame输出的JobBuilder 由于确定了输入输出，所以默认实现了SparkCacheableJobBuilder
 *
 * @param <C> 配置类
 */
public interface SparkProcessTableBuilder<C> extends SparkProcessJobBuilder<Dataset<Row>, Dataset<Row>, C>,
