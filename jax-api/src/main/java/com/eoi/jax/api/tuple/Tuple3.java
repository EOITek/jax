...
/**
 * A tuple with 3 fields. Tuples are strongly typed; each field may be of a separate type. The fields of the tuple can
 ...
 * type. (That is, if you have a "class Foo extends Tuple3", then don't use instances of Foo in a
 * DataStream&lt;Tuple3&gt; / DataSet&lt;Tuple3&gt;, but declare it as DataStream&lt;Foo&gt; / DataSet&lt;Foo&gt;.)
 * </li>
 * </ul></p>
 *
...
public class Tuple3<T0, T1, T2> extends Tuple {
    ...
    /**
     * Creates a string representation of the tuple in the form (f0, f1, f2), where the individual fields are the value
