...
public class YarnJobGetParam extends BaseYarnJob implements JobGetParam {
    ...
    public YarnJobGetParam setTimeOutMs(Integer timeOutMs) {
    ...
    public YarnJobGetParam setApplicationId(String applicationId) {
    ...
    public YarnJobGetParam setPrincipal(String principal) {
    ...
    public YarnJobGetParam setKeytab(String keytab) {
        this.keytab = keytab;
        return this;
    }
