...
public class ValidateResult {
    ...
    public ValidateResult putInvalidJobConfig(String key, String value) {
        if (this.invalidJobConfig == null) {
            this.invalidJobConfig = new LinkedHashMap<>();
        }
        this.invalidJobConfig.put(key, value);
        return this;
    }
}
