 ...
 */
public final class CustomStreamTableEnvironmentImpl extends CustomTableEnvironmentImpl
        implements StreamTableEnvironment {

    private final StreamExecutionEnvironment executionEnvironment;

    public CustomStreamTableEnvironmentImpl(
    ...
    public static StreamTableEnvironment create(
        ...
        return new CustomStreamTableEnvironmentImpl(
                catalogManager,
                moduleManager,
                functionCatalog,
                tableConfig,
