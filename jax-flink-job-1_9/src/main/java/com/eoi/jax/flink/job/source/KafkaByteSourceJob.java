...
public class KafkaByteSourceJob implements FlinkSourceJobBuilder<DataStream<Map<String,Object>>, KafkaByteSourceJobConfig> {
    ...
    public DataStream<Map<String,Object>> build(FlinkEnvironment context, KafkaByteSourceJobConfig config, JobMetaConfig metaConfig) {
        ...
        DataStream<Map<String,Object>> sourceStream = context.streamEnv.addSource(kafkaConsumer).name(metaConfig.getJobEntry()).uid(metaConfig.getJobId());
