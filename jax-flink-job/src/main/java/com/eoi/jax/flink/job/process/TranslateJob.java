...
@Job(
        name = "TranslateJob",
        display = "字段映射",
        description = "对某个字段进行字典映射",
        icon = "TranslateJob.svg",
        doc = "TranslateJob.md",
        category = OperatorCategory.FIELD_PROCESSING
)
public class TranslateJob implements FlinkProcessJobBuilder<
    ...
    public Tuple2<DataStream<Map<String, Object>>, DataStream<Map<String, Object>>> build(
        ...
        SingleOutputStreamOperator<Map<String, Object>> output = mapDataStream
                .process(new TranslateFunction(config, errorTag))
    ...
    @Override
    public TranslateJobConfig configure(Map<String, Object> mapConfig) throws Throwable {
        return TranslateJobConfig.fromMap(mapConfig);
    }
}
