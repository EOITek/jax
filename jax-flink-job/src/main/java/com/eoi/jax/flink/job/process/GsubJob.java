...
@Job(
        name = "GsubJob",
        display = "文本替换",
        description = "对字符串进行普通或正则替换",
        doc = "GsubJob.md",
        icon = "GsubJob.svg",
        category = OperatorCategory.TEXT_ANALYSIS
)
public class GsubJob implements FlinkProcessJobBuilder<
    ...
    public Tuple2<DataStream<Map<String, Object>>, DataStream<Map<String, Object>>> build(
            ...
            GsubJobConfig config, JobMetaConfig metaConfig) throws Throwable {
        ...
        SingleOutputStreamOperator<Map<String, Object>> output = mapDataStream
                .process(new GsubFunction(config, errorTag))
    ...
    @Override
    public GsubJobConfig configure(Map<String, Object> mapConfig) throws Throwable {
        return GsubJobConfig.fromMap(mapConfig);
    }
}
