...
@Job(
        name = "TypeConvertJob",
        display = "类型转换",
        description = "对指定的字段进行类型转换",
        icon = "TypeConvertJob.svg",
        doc = "TypeConvertJob.md",
        category = OperatorCategory.DATA_TYPE_CONVERSION
)
public class TypeConvertJob implements FlinkProcessJobBuilder<
        DataStream<Map<String, Object>>,
        Tuple2<DataStream<Map<String, Object>>, DataStream<Map<String, Object>>>,
        TypeConvertJobConfig> {
    ...
    public Tuple2<DataStream<Map<String, Object>>, DataStream<Map<String, Object>>> build(
        ...
        SingleOutputStreamOperator<Map<String, Object>> output = dataStream
                .process(new TypeConvertFunction(config, errorTag))
    ...
    @Override
    public TypeConvertJobConfig configure(Map<String, Object> mapConfig) throws Throwable {
        TypeConvertJobConfig config = new TypeConvertJobConfig();
